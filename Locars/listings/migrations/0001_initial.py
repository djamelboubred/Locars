    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel', models.CharField(choices=[('A', 'Essence'), ('B', 'Diesel'), ('C', 'Hybride'), ('D', 'Électrique')], max_length=1)),
                ('geardbox', models.CharField(blank=True, choices=[('A', 'Automatique'), ('B', 'Manuelle')], max_length=1, null=True)),
